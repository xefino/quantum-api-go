...
var file_protos_frontend_data_ohlc_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x78, 0x65, 0x66, 0x69, 0x6e, 0x6f, 0x2f, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x75, 0x6d,
	0x2d, 0x61, 0x70, 0x69, 0x2d, 0x67, 0x6f, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_protos_frontend_data_ohlc_proto_goTypes = []interface{}{
	(*Bar)(nil),                // 0: protos.frontend.data.Bar
	(*gopb.UnixTimestamp)(nil), // 1: protos.common.UnixTimestamp
}
var file_protos_frontend_data_ohlc_proto_depIdxs = []int32{
	1, // 0: protos.frontend.data.Bar.timestamp:type_name -> protos.common.UnixTimestamp

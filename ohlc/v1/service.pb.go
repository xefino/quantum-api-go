...
type GetAggregatesRequest struct {
	...
	From *gopb.UnixTimestamp `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"` // enable-default
	// The ending time from which to pull aggregated data as a timestamp
	To *gopb.UnixTimestamp `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"` // enable-default
	...
	Frequency Frequency `protobuf:"varint,5,opt,name=frequency,proto3,enum=protos.frontend.ohlc.v1.Frequency" json:"frequency,omitempty"` // enable-default

...
func RegisterQuoteServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QuoteServiceServer) error {
	...
	mux.Handle("POST", pattern_QuoteService_GetQuotesForAsset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterQuoteServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QuoteServiceClient) error {
	...
	mux.Handle("POST", pattern_QuoteService_GetQuotesForAsset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/protos.frontend.quoted.v1.QuoteService/GetQuotesForAsset", runtime.WithHTTPPathPattern("/quotes/{symbol}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
